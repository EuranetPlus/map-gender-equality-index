export const config = {
	mapTitle: 'gender-equality', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-gender-equality-index.vercel.app/', // The url provided when deploying the map on Vercel
